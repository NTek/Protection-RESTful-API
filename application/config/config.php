...
/*
 |--------------------------------------------------------------------------
 | Auto Load Classes, this hack disables $this->load->model...
 |### Added by NITRO
 |--------------------------------------------------------------------------
 */
function __autoload($class) {
	if (file_exists(APPPATH."data/".strtolower($class).EXT)) {
		include_once(APPPATH."data/".strtolower($class).EXT);
	} else if (file_exists(APPPATH."constants/".strtolower($class).EXT)) {
		include_once(APPPATH."constants/".strtolower($class).EXT);
